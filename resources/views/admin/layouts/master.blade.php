...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="{{asset('assets/admin/adminLTE/bower_components/morris.js/morris.css')}}">
  <!-- jvectormap -->
  <link rel="stylesheet" href="{{asset('assets/admin/adminLTE/bower_components/jvectormap/jquery-jvectormap.css')}}">
  <!-- Date Picker -->
...
<div class="wrapper">
  ...
  @include('admin.layouts.main-menu', compact('adminMenu', 'currentController', 'currentAction'))
...
<!-- jQuery UI 1.11.4 -->
<script src="{{asset('assets/admin/adminLTE/bower_components/jquery-ui/jquery-ui.min.js')}}"></script>
...
<!-- Morris.js charts -->
<script src="{{asset('assets/admin/adminLTE/bower_components/raphael/raphael.min.js')}}"></script>
<script src="{{asset('assets/admin/adminLTE/bower_components/morris.js/morris.min.js')}}"></script>
<!-- Sparkline -->
<script src="{{asset('assets/admin/adminLTE/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js')}}"></script>
<!-- jvectormap -->
<script src="{{asset('assets/admin/adminLTE/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js')}}"></script>
<script src="{{asset('assets/admin/adminLTE/plugins/jvectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
<!-- jQuery Knob Chart -->
<script src="{{asset('assets/admin/adminLTE/bower_components/jquery-knob/dist/jquery.knob.min.js')}}"></script>
<!-- daterangepicker -->
<script src="{{asset('assets/admin/adminLTE/bower_components/moment/min/moment.min.js')}}"></script>
...
<script> 
  ...
  var config = {
      locales: {!! json_encode(config('translatable.locales')) !!},
  };
</script>
