...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Products
        <small><a href="{!! route('admin.products.create') !!}"><i class="fa fa-plus"></i></a></small>
      </h1>
      <ol class="breadcrumb">
                ...
                <div class="box">   
                    <div class="box-body">
                        <div class="table-responsive p-0">
                            <table class="table table-hover table-bordered table-striped" id="data-table" data-api="{{ route('api.admin.products.index') }}" data-route="{{ route('admin.products.index') }}">
                                <thead>
                                    <tr>
                                        <th> Nama Product </th>
                                        <th> Description </th>
